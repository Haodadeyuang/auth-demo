...
layui.define(['element', 'layer', 'form'], function (exports) {
    ...
    function login() {
        ...
        loginHtml += '<form class="layui-form" method="POST" action="checkLogin">';
        ...
        loginHtml += '<input type="text" name="name" lay-verify="account" placeholder="请输入账号"  autocomplete="off" class="layui-input">';
        loginHtml += '</div>';
        loginHtml += '</div>';
        loginHtml += '<div class="layui-form-item">';
