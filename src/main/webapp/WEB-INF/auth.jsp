...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <div class="ht-console">
            <div class="ht-user">
                <img src="../resources/images/Logo_40.png"/>
        ...
        <ul class="ht-nav">
            ...
            <li class="ht-nav-item">
                <a href="javascript:;" id="individuation"><i class="fa fa-tasks fa-fw"
                                                             style="padding-right:5px;"></i>个性化</a>
            </li>
            <li class="ht-nav-item">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="datalist.html" data-id="1">文章管理</a>
                        </dd>
                        <dd><a href="javascript:;" data-url="datalist.html" data-id="2">资源管理</a>
                        </dd>
                        <dd><a href="javascript:;" data-url="datalist.html" data-id="3">时光轴管理</a>
                        </dd>
                        <dd><a href="javascript:;">笔记本管理</a></dd>
                        <dd><a href="javascript:;" data-url="datalist.html" data-id="4">文章回收站</a>
                        </dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" data-url="datalist.html" data-id="5">网站公告</a>
                        </dd>
                        <dd><a href="javascript:;" data-url="datalist.html" data-id="6">更新日志</a>
                        </dd>
                        <dd><a href="javascript:;" data-url="datalist.html" data-id="7">留言管理</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
    ...
    <div class="layui-body">
        <div style="margin:0;position:absolute;top:4px;bottom:0px;width:100%;"
             class="layui-tab layui-tab-brief" lay-filter="tab" lay-allowclose="true">
    ...
    <div class="individuation animated flipOutY layui-hide">
        ...
        <div class="setting-item layui-form">
            <span>侧边导航</span>
            <input type="checkbox" lay-skin="switch" lay-filter="sidenav"
                   lay-text="ON|OFF" checked>
        </div>
        <div class="setting-item layui-form">
            <span>管家提醒</span>
            <input type="checkbox" lay-skin="switch" lay-filter="steward"
                   lay-text="ON|OFF" checked>
        </div>
