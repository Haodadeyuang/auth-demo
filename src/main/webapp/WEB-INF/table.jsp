...
<div class="mainpanel">
    ...
    <div class="pageheader">
        <h2><i class="fa fa-edit"></i> 个人信息 <span></span></h2>
    ...
    <div class="contentpanel">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">编辑个人信息</h4>
                <p>您所作的一切修改都会显示在您的个人主页上，如果您不想告知他人相关信息，请直接将对应的信息<code>留空</code>。
            </div>
            <div class="panel-body panel-body-nopadding">

                <form name="UserInfoForm" action="/updateUserInfo" method="post"
                      class="form-horizontal form-bordered">

                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="readonlyinput">登录名
                        </label>
                        <div class="col-sm-6">
                            <input type="text" name="user_name" value="<%=session.getAttribute("UserName")%>" id="readonlyinput" class="form-control" readonly="readonly" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text"
                                   name="user_mailbox" placeholder="<%= userinfo.getUser_mailbox() %>"
                                   value="<%= userinfo.getUser_mailbox() %>"
                                   class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            userinfo.getUser_phone() %>" value="<%=
                            userinfo.getUser_phone() %>"
                                   title="电话号码会显示在您的个人主页"
                                   data-toggle="tooltip" data-trigger="hover" class="form-control tooltips" />
                        </div>
                    </div>


                    <div class="form-group">
                        <label class="col-sm-3 control-label">姓氏名字</label>

                        <div class="col-sm-2">
                            <input type="text" name="user_firstname" placeholder="<%=
                            userinfo.getUser_firstname() %>"
                                   value="<%=
                            userinfo.getUser_firstname() %>"
                                   class="form-control">
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">工作职位</label>
                        <div class="col-sm-5">
                            <input type="text" name="user_job"
                                   placeholder="<%= userinfo.getUser_job() %>"
                                   value="<%= userinfo.getUser_job() %>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="user_city" class="select2-2"
                                    data-placeholder="所在地">
                                <option selected="selected"
                                        value="<%= userinfo.getUser_city() %>"></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="user_location" placeholder="<%=
                            userinfo.getUser_location() %>" value="<%=
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea name="user_about"
                                      class="form-control"
                                      placeholder="<%=
                            userinfo.getUser_about() %>" rows="5"><%=
                            userinfo.getUser_about() %></textarea>
                        </div>
                    </div>
